...
const Footer = () => {
  return (
    <div
      id="contactus"
      className="text-white w-full flex justify-center  bg-gradient-to-t px-4 lg:px-44 pt-20 pb-10  from-gradientNavyBlue to-black "
    >
      <div className="container">
        <div className="flex flex-col w-full ">
          ...
          <div className="flex justify-center">
            <p className="text-xs font-light px-4 lg:px-36 text-center opacity-70 leading-6">
          ...
          <div className="flex justify-between mt-2">
            <div className="text-[0.6rem] lg:text-[0.7rem] font-light opacity-50 ">
              Copyright © 2022, 777 Club
            </div>
            <div>
              <ul className="flex gap-3 lg:gap-5 text-[0.5rem] lg:text-[0.7rem] opacity-50 font-light">

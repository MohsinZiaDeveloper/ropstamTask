...
const MeetTeam = () => {
  return (
    <div className="flex justify-center   mt-[-3rem]  py-20 backdrop-blur-xl bg-cover text-white  h-auto overflow-hidden  bg-no-repeat  bg-[url('assets/Roadmap.png')]">
      <div className="container flex flex-col">
        ...
        <div className="w-full flex mt-10 px-[12rem]">
          <div className="w-3/4  grid pl-20 pr-20 items-center flex-col">
            <div className="">
              <div className="flex ">
                <p className="text-sm leading-6 pr-44 font-light opacity-70">

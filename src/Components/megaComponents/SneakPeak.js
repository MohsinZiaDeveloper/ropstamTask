...
const SneakPeak = () => {
  return (
    <div
      id="walletCollection"
      className="flex justify-center py-0 lg:py-20 bg-cover   h-auto overflow-hidden  bg-no-repeat  bg-[url('assets/sneakPeakBgimage.png')]"
    >
      <div className="container flex flex-col ">
        <div className="w-full text-white flex justify-center">
          <h3 className="text-3xl font-bold">Sneak Peak</h3>
        </div>
        <div className="flex flex-col lg:flex-row w-full mt-10 lg:mt-20 px-5 lg:px-32">

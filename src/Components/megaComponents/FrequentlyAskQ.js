...
const FrequentlyAskQ = () => {
  ...
  return (
    <div className="flex flex-col py-20 backdrop-blur-xl bg-cover text-white  h-auto overflow-hidden  bg-no-repeat  bg-[url('assets/frequentAskQuestionBg.png')]">
      <div className="flex justify-center w-full ">
        <h3 className="text-3xl font-bold">Frequently Asked Questions</h3>
      </div>
      <div className="flex w-full  gap-4 justify-center px-[10rem] mt-20">
              ...
              <div className="flex mt-4 flex-col">
                ...
                {Leftindex === index && (
                  <div className="bg-trasnparent">
                    <p className="px-5 pr-7 pt-3 text-xs leading-5 font-light">
                      {items.answer}
                    </p>
                  </div>
                )}
          ...
          {rightfreqQustion.map((items, index) => {
            return (
              <div className="flex mt-[0.85rem] flex-col">
                ...
                {rightindex === index && (
                  <div className="bg-trasnparent">
                    <p className="px-5 pr-7 py-5 text-xs leading-5 font-light">
                      {items.answer}
                    </p>
                  </div>
                )}

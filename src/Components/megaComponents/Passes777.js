...
const Passes777 = () => {
  return (
    <div className="flex justify-center lg:flex lg:flex-row py-20 bg-cover   h-auto overflow-hidden  bg-no-repeat  bg-[url('assets/passes777bgImage.png')]">
      <div className="container flex ">
        ...
        <div className="w-full lg:w-1/2 text-white flex flex-col  pl-10 pr-32 items-start">
          ...
          <p className="text-xs font-light mt-4 leading-6 opacity-70">
          ...
          <p className="text-xs font-light mt-5 leading-6 opacity-70">

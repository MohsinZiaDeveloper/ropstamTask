...
const Passes777 = () => {
  return (
    <div className="flex flex-col lg:flex lg:flex-row py-20 bg-cover   h-auto overflow-hidden  bg-no-repeat  bg-[url('assets/passes777bgImage.png')]">
      <div className="flex w-full lg:w-1/2 items-center pr-10  justify-end ">
      ...
      <div className="w-full lg:w-1/2 text-white flex flex-col  pl-10 pr-32 items-start">
        <h3 className="text-3xl font-bold">The 777 Club</h3>
        <p className="text-xs font-light mt-4 leading-6">
          ...
          like none-other, a metaverse social club, connections to new business
          opportunities, and a ton more.
        </p>
        <p className="text-xs font-light mt-5 leading-6">
